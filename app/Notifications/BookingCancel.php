...
class BookingCancel extends Notification
{
    ...
    public function toMail($notifiable)
    {
        ...
        return (new MailMessage)
            ...
            ->line(__('app.booking').' '.__('app.date').' - '.$this->booking->date_time->format($this->settings->date_format))
            ->line(__('app.booking').' '.__('app.time').' - '.$this->booking->date_time->format($this->settings->time_format))
