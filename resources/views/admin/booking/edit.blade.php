...
@if ($current_url == 'calendarPage')
    <div class="modal-header">
        <h4 class="modal-title">@lang('app.edit') @lang('app.booking')</h4>
            ...
            <div class="col-md-6 border-top">
                <div class="row">
                    <div class="col-md-12">
                        <table class="table table-condensed">
                            <tr class="h6">
                                <td class="border-top-0 text-right w-50">@lang('app.serviceSubTotal')</td>
                            ...
                            @if($booking->deal_id == '')
                                <tr class="h6">
                                    ...
                                    <td><input type="number" id="cart-discount" name="cart_discount" class="form-control" step=".01" min="0" value="{{ currencyFormatter($booking->discount_percent) }}"></td>
                                </tr>
                            @endif

                            <tr class="h6">
                                <td class="text-right">@lang('app.productSubTotal')</td>
