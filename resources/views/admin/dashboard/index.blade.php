...
@section('content')
    ...
    <div class="row mb-2">
        ...
        @endif
        @if ($settings->website != url('/') && $user->is_admin)
        <div class="col-md-12">
            <div class="alert alert-warning">
                    <div class="row">
                        ...
                        <div class="col-md-2 text-right">
                            <a href="{{ route('admin.settings.index') }}" ><button type="button" role="button" class="btn btn-success">@lang('app.update')</button> </a>
                        </div>
                    </div>
            </div>
        </div>
                                    ...
                                    @forelse($recentSales as $booking)
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <li>{{ ucwords(is_null($item->business_service_id) ? $item->product->name : $item->businessService->name) }} x{{ $item->quantity }}</li>
                                                @endforeach
                                                </ol>
                                            </td>
                                            <td class="text-muted">
