                        ...
                        <div class="row">
                            <div class="col-md-12">
                                    ...
                                    <div class="row">
                                        <div class="col-md-11">
                                            <div class="form-row">
                                                ...
                                                <div class="col-md-8">
                                                    <input type="text" class="form-control" name="mobile" value="{{ $employee->mobile }}" autocomplete="off">
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <div class="row">
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            <input class="form-control form-control-lg" placeholder="@lang('front.registration.houseNo')" name="house_no" type="text" @if($employee && $employee->address) value="{{ $employee->address->house_no }}" @endif>
                                        </div>
                                    </div>
                                    <div class="col-md-9">
                                        <div class="form-group">
                                            <input class="form-control form-control-lg" placeholder="@lang('front.registration.addressLine')" name="address_line" type="text" @if($employee && $employee->address) value="{{ $employee->address->address_line }}" @endif>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <input class="form-control form-control-lg" placeholder="@lang('front.registration.city')" name="city" type="text" @if($employee && $employee->address) value="{{ $employee->address->city }}" @endif>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <input class="form-control form-control-lg" placeholder="@lang('front.registration.state')" name="state" type="text" @if($employee && $employee->address) value="{{ $employee->address->state }}"@endif>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <input class="form-control form-control-lg" placeholder="@lang('front.registration.pincode')" name="pin_code" type="text" @if($employee && $employee->address) value="{{ $employee->address->pin_code }}"@endif>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <select name="country_id" id="country_id" class="form-control form-control-lg select2">
                                                @foreach($countries as $country)
                                                    <option @if ($employee && $employee->address && $country->id == $employee->address->country_id) selected @endif value="{{$country->id}}">{{ $country->name }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="service_id[]" id="service_id" class="form-control" multiple="multiple" style="width: 100%">
