            ...
            <div class="card">
                <div class="card-body">
                    <div class="d-flex justify-content-center justify-content-md-end mb-3">
                        <a href="{{ route('admin.employee-leaves.index') }}" class="btn btn-rounded mb-1 mr-2" style="background-color: #6666b9; color:#ffffff;"><i class="fa fa-rocket"></i> @lang('app.employee') @lang('app.leave')</a>
