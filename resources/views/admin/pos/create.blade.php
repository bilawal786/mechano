            ...
            <form id="filter-form" class="ajax-form" method="GET">
                <div class="card card-light">
                    <div class="card-header">
                        <div class="row">
                            <div class="col-lg-4">
                                <label class="col-sm-12 col-form-label">@lang('app.product') / @lang('app.service')
                                ...
                                <div class="coupons-base-content justify-content-between d-flex align-items-center">
                                    ...
                                    <div>
                                        <button type="button" onclick="removeCoupon();"
                                            class="btn btn-success btn-outline-danger remove-button"> @lang('app.remove')
                                        </button>
                                    </div>
                                </div>
                            </div>
...
@push('footer-js')
    ...
    <script>
        ...
        $('#type-filter, #category-filter, #location-filter').change(function () {
            posDataGet();
        });
