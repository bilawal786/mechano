...
<form class="form-horizontal ajax-form" id="sms-setting-form" method="POST">
    ...
    <div class="row">
        <div class="col-md-12 ">
            <h5 class="text-primary">@lang('app.nexmoCredential') </h5>
        ...
        <div class="col-md-12">
            <h5 class="text-primary">@lang('app.msg91Credential') </h5>
            <div class="form-group">
                <label class="control-label">
