                        ...
                        @if ($booking->deal_id=='')
                            <ul>
                                ...
                                <span>
                                    ...
                                    <span>
                                    {{ currencyFormatter($booking->amount_to_pay) }}
                                </span>
                                </li>
                                <li>
                                    <span>
                    ...
                    @if($credentials->show_payment_options == 'show')
                        <div class="payment-type">
                            ...
                            <div class="payments">
                                ...
                                <a href="javascript:;" onclick="payWithPaystack();" id="paystackPaymentButton" class="btn btn-custom btn-blue"><i class="fa fa-money mr-2"></i>@lang('front.buttons.paystack')</a>
                                @endif
